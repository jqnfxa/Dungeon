...
class PlayerStatistic : public sf::Drawable, public sf::Transformable {
	...
	static constexpr int32_t stats_count = 5;
	static constexpr double step_coefficient_ = 1.0 / 5;
...
public:
	PlayerStatistic();
	void initialize(const sf::Vector2u &parent_size, const sf::Vector2u &size, sf::Font &font, STATISTIC_ALIGNMENT alignment = RIGHT_ALIGNMENT);
